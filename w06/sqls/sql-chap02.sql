...
SELECT da + db, fa, fb, fa + fb, da + db = 0.3, fa + fb = 0.3 FROM numerics;

-- use abs() function to compare approximate value
SELECT da + db = 0.3, fa + fb = 0.3, abs(fa + fb - 0.3) <= 0.000000005, fa + fb FROM numerics;
...
INSERT INTO temp(name) values('Duc Le');
UPDATE temp SET name = 'Jackson Pollack' WHERE id = 1;
