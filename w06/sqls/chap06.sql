...
-- this query fails because of UPDATE RESTRICT
UPDATE widgetCustomer SET id = 9 WHERE id = 2;

-- this works and widgeSale.customer_id is set to NULL
delete from widgetCustomer WHERE id = 2;

-- Alter the FK constraint (custid) (see Section 02 below) 
-- to UPDATE...CASCADE
-- then try the UPDATE statement above again. See the difference!
-- the query now works!
